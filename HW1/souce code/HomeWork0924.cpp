...
//			newpos = ( height - y - 1 ) * total_scanlinebytes + x;
			...
			// InputImage1 must do swap R&B
			// Lena64 and Lena1024 don't swap R&B
			newbuf[ newpos ] = 255 - pmatrix[ bufpos ];
			newbuf[ newpos + 1 ] = 255 - pmatrix[ bufpos + 1 ];
			newbuf[ newpos + 2 ] = 255 - pmatrix[ bufpos + 2 ];
		}
	}
...
int main(){
	...
	BYTE* bytes = LoadBMP( &imageWidth, &imageHeight, &imageSize, "E:\\course\\Advance Computer Vision\\HW1\\Lena1024.BMP" );
	...
	SaveBitmapToFile( (BYTE*) &newbuf2[ 0 ],
	                  ...
	                  24,
	                  padding,
	                  "E:\\course\\Advance Computer Vision\\HW1\\ImageWrite.bmp" );
	...
	SaveBitmapToFile( (BYTE*) &newbuf3[ 0 ],
	                  ...
	                  24,
	                  padding,
	                  "E:\\course\\Advance Computer Vision\\HW1\\Image180Rotation.bmp" );	 
	...
	SaveBitmapToFile( (BYTE*) &newbuf4[ 0 ],
	                  ...
	                  24,
	                  padding,
	                  "E:\\course\\Advance Computer Vision\\HW1\\ImageColorNegtive.bmp" );						                   
